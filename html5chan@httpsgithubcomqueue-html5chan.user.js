...
inject( "http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.js",
	...
	$.fn.exists = function (selector) { return (selector ? this.filter(selector) : this ).length > 0;}
