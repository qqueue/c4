...
function parse4chan() {
	...
	return {
		nfsw: $('link[rel=stylesheet]')[0].href == 'http://static.4chan.org/css/yotsuba.9.css', //the yellow theme
		nav: $('#navtop').html(),
